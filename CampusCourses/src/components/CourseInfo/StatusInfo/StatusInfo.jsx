            ...
            <Space wrap className={styles.status}>
                <Space direction="vertical">
                    ...
                    {isLoading || !courseInfo ? (
                        ...
                        <Text strong style={{ color: getStatusStyle(courseInfo?.status) }}>
                            {getCourseStatus(courseInfo?.status)}
                        </Text>
                    )}
                </Space>
                <Space direction="horizontal">
                    ...
                    {currentCourseRole === currentCourseRoles.none() &&
                        courseInfo?.status === courseStatus.openForAssigning() && (
                            <Button type="primary" loading={loading} onClick={signUp}>
                                Записаться
                            </Button>
                        )}
                </Space>
